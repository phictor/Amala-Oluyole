...
const styles = StyleSheet.create({
  ...
  mealImage: { width: 80, height: 80, borderRadius: 10, backgroundColor: '#F0E4D8' },
  mealInfo: { flex: 1 },
  mealName: { fontSize: 15, fontWeight: '700', color: '#1A0F0A', marginBottom: 4 },
  mealDesc: { fontSize: 12, color: '#8B6F5E', marginBottom: 6 },
  ...
  browseBtn: { backgroundColor: '#C0392B', borderRadius: 14, paddingVertical: 12, paddingHorizontal: 28 },
