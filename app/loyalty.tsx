...
const styles = StyleSheet.create({
  ...
  guestTitle: { fontSize: 20, fontWeight: '700', color: '#1A0F0A', marginBottom: 24, textAlign: 'center' },
  signInBtn: { backgroundColor: '#C0392B', borderRadius: 14, paddingVertical: 14, paddingHorizontal: 40 },
  ...
  statCard: { flex: 1, backgroundColor: '#FFF', borderRadius: 14, padding: 14, alignItems: 'center', borderWidth: 1, borderColor: '#E8D5C4' },
  statValue: { fontSize: 20, fontWeight: '800', color: '#C0392B' },
  statLabel: { fontSize: 11, color: '#8B6F5E', marginTop: 2, textAlign: 'center' },
  section: { paddingHorizontal: 20, marginBottom: 20 },
  sectionTitle: { fontSize: 18, fontWeight: '800', color: '#1A0F0A', marginBottom: 12 },
  benefitRow: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 8 },
  benefitCheck: { fontSize: 18 },
  benefitText: { fontSize: 15, color: '#1A0F0A' },
  earnCard: { backgroundColor: '#FFF', borderRadius: 14, padding: 14, borderWidth: 1, borderColor: '#E8D5C4', gap: 10 },
  earnRow: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  earnIcon: { fontSize: 22 },
  earnText: { fontSize: 15, color: '#1A0F0A' },
  txRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: '#F0E4D8' },
  txDesc: { fontSize: 14, color: '#1A0F0A' },
  txDate: { fontSize: 12, color: '#8B6F5E', marginTop: 2 },
