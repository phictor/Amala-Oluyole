...
### Kitchen Subdomain Deployment
- [ ] Audit deployment routing and configuration for kitchen.amalaoluyole.com
- [ ] Add kitchen subdomain routing so staff land directly in the protected kitchen portal
- [ ] Write DNS, SSL, and external-hosting handover instructions for kitchen.amalaoluyole.com
- [ ] Validate the dedicated kitchen hostname configuration and publish the handover update

### Temporary Manus Kitchen Access
- [x] Ensure the primary Manager account entering through /staff/kitchen opens the Kitchen workspace directly
- [x] Verify temporary Manus kitchen sign-in, staff-only access, and desktop visibility before custom-domain work
