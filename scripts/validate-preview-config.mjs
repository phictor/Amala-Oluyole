...
assert.equal(preview.version, development.version);
assert.notEqual(preview.version, production.version);
assert.deepEqual(preview.runtimeVersion, { policy: "appVersion" });
assert.deepEqual(development.runtimeVersion, { policy: "appVersion" });
...
assert(packageJson.dependencies["expo-asset"]);
